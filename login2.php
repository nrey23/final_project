...
<head>
    ...
    <style>
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(assets/img/education/bg1.jpg);
...
<body>
    <div class="wrapper"> <img src="admin.jpg" width="90%" height="90%" class="img"><hr>
