...
if(isset($_POST['submit'])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $sql = "INSERT INTO `registrar` (studentName, studentId, email, service, rating, feedback, status) VALUES (?, ?, ?, ?, ?, ?, ?)";
...
<body class="admissions-page">
  ...
  <main class="main">
    ...
    <!-- Page Title -->
    <div class="page-title dark-background" style="background-image: url(assets/img/education/bg3.jpg);">
      <div class="container position-relative">
        <h1>Registrar Feedback</h1>
        <p>Provide feedback on registrar services such as transcript requests, enrollment verification, and document authentication.</p>
    ...
    <!-- Registrar Feedback Section -->
    <section id="registrar-feedback" class="section">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row justify-content-center">
          <!-- Registrar Info Card (Left Side) -->
          <div class="col-lg-5 mb-4 mb-lg-0">
            <div class="card h-100 shadow-sm border-0">
              <div class="card-body">
                <div class="text-center mb-3">
                  <i class="bi bi-person-badge-fill" style="font-size: 2.5rem; color: #800000;"></i>
                </div>
                <h4 class="card-title text-center mb-3">Office of the Registrar</h4>
                <ul class="list-unstyled mb-3">
                  ...
                  <li class="mb-2"><i class="bi bi-envelope-fill me-2 text-primary"></i>registrar@g.msuiit.edu.ph</li>
                  <li class="mb-2"><i class="bi bi-telephone-fill me-2 text-primary"></i>+63 (063) 223 3794</li>
                  <li class="mb-2"><i class="bi bi-clock-fill me-2 text-primary"></i>Mon–Fri: 8:00am – 5:00pm</li>
                </ul>
                <p>
                  The Registrar's Office is responsible for student records, transcript requests, enrollment verification, ID issuance, and more. We are committed to providing efficient and friendly service to all students and alumni.
                </p>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                  ...
                  <div class="mb-3">
                    ...
                    <select name="service" class="form-select" id="service" required>
                      ...
                      <option value="ID Issuance">ID Issuance</option>
