...
if(isset($_POST['submit'])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $sql = "INSERT INTO `library` (studentName, studentId, email, service, rating, feedback, status) VALUES (?, ?, ?, ?, ?, ?, ?)";
...
<body class="admissions-page">
  ...
  <main class="main">
    ...
    <!-- Page Title -->
    <div class="page-title dark-background" style="background-image: url(assets/img/education/bg4.jpg);">
      <div class="container position-relative">
        <h1>Library Feedback</h1>
        <p>Submit your feedback about library services, including book borrowing, study rooms, and digital resources.</p>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.php">Home</a></li>
            <li class="current">Library Feedback</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
    ...
    <section id="library-feedback" class="section">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row justify-content-center">
          <!-- Library Info Card (Left Side) -->
          <div class="col-lg-5 mb-4 mb-lg-0">
            <div class="card h-100 shadow-sm border-0">
              <div class="card-body">
                <div class="text-center mb-3">
                  <i class="bi bi-journal-bookmark-fill" style="font-size: 2.5rem; color: #800000;"></i>
                </div>
                <h4 class="card-title text-center mb-3">University Library</h4>
                <ul class="list-unstyled mb-3">
                  <li class="mb-2"><i class="bi bi-geo-alt-fill me-2 text-primary"></i>MSU-Iligan Institute of Technology
                  Andres Bonifacio Avenue, Tibanga, 9200 Iligan City, Philippines</li>
                  <li class="mb-2"><i class="bi bi-envelope-fill me-2 text-primary"></i>library@g.msuiit.edu.ph</li>
                  <li class="mb-2"><i class="bi bi-telephone-fill me-2 text-primary"></i>+63.63.221.4050 local 4148</li>
                  <li class="mb-2"><i class="bi bi-clock-fill me-2 text-primary"></i>Mon–Sat: 7:30am – 8:00pm</li>
                </ul>
                <p>
                  The University Library offers a wide range of resources, study spaces, and support services for students and faculty. Our staff is here to help you access books, journals, digital materials, and research assistance.
                </p>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                  ...
                  <div class="mb-3">
                    ...
                    <select name="service" class="form-select" id="service" required>
                      ...
                      <option value="Reference Assistance">Reference Assistance</option>
                      <option value="Study Room Reservation">Study Room Reservation</option>
